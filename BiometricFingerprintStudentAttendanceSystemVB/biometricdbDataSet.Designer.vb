...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("biometricdbDataSet"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class biometricdbDataSet
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As biometricdbDataSet = CType(MyBase.Clone,biometricdbDataSet)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "biometricdbDataSet"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/biometricdbDataSet.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As biometricdbDataSet = New biometricdbDataSet()
    ...
    Partial Public Class AttendanceDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddAttendanceRow(ByVal StudentId As String, ByVal Name As String, ByVal _Date As String, ByVal Day As String, ByVal TimeIn As String, ByVal TimeOut As String) As AttendanceRow
            Dim rowAttendanceRow As AttendanceRow = CType(Me.NewRow,AttendanceRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, StudentId, Name, _Date, Day, TimeIn, TimeOut}
...
Namespace biometricdbDataSetTableAdapters
    ...
    Partial Public Class AttendanceTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Attendance] WHERE (([Id] = @Original_Id) AND ([StudentId] = @O"& _ 
                "riginal_StudentId) AND ([Name] = @Original_Name) AND ([Date] = @Original_Date) A"& _ 
                "ND ([Day] = @Original_Day) AND ((@IsNull_TimeIn = 1 AND [TimeIn] IS NULL) OR ([T"& _ 
                "imeIn] = @Original_TimeIn)) AND ((@IsNull_TimeOut = 1 AND [TimeOut] IS NULL) OR "& _ 
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Attendance] ([StudentId], [Name], [Date], [Day], [TimeIn], [Ti"& _ 
                "meOut]) VALUES (@StudentId, @Name, @Date, @Day, @TimeIn, @TimeOut);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id, "& _ 
                "StudentId, Name, Date, Day, TimeIn, TimeOut FROM Attendance WHERE (Id = SCOPE_ID"& _ 
                "ENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Attendance] SET [StudentId] = @StudentId, [Name] = @Name, [Date] = "& _ 
                "@Date, [Day] = @Day, [TimeIn] = @TimeIn, [TimeOut] = @TimeOut WHERE (([Id] = @Or"& _ 
                "iginal_Id) AND ([StudentId] = @Original_StudentId) AND ([Name] = @Original_Name)"& _ 
                " AND ([Date] = @Original_Date) AND ([Day] = @Original_Day) AND ((@IsNull_TimeIn "& _ 
                "= 1 AND [TimeIn] IS NULL) OR ([TimeIn] = @Original_TimeIn)) AND ((@IsNull_TimeOu"& _ 
                "t = 1 AND [TimeOut] IS NULL) OR ([TimeOut] = @Original_TimeOut)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id, S"& _ 
                "tudentId, Name, Date, Day, TimeIn, TimeOut FROM Attendance WHERE (Id = @Id)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.BiometricFingerprintStudentAttendanceSystemVB.My.MySettings.Default.biometricdbConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Id, StudentId, Name, Date, Day, TimeIn, TimeOut FROM dbo.Attendance"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As biometricdbDataSet.AttendanceDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As biometricdbDataSet.AttendanceDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As biometricdbDataSet.AttendanceDataTable = New biometricdbDataSet.AttendanceDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As biometricdbDataSet.AttendanceDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As biometricdbDataSet) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Id As Integer, ByVal Original_StudentId As String, ByVal Original_Name As String, ByVal Original_Date As String, ByVal Original_Day As String, ByVal Original_TimeIn As String, ByVal Original_TimeOut As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal StudentId As String, ByVal Name As String, ByVal _Date As String, ByVal Day As String, ByVal TimeIn As String, ByVal TimeOut As String) As Integer
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(4).Value = CType(TimeIn,String)
            End If
            If (TimeOut Is Nothing) Then
                Me.Adapter.InsertCommand.Parameters(5).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(5).Value = CType(TimeOut,String)
            End If
        ...
        Public Overloads Overridable Function Update(ByVal StudentId As String, ByVal Name As String, ByVal _Date As String, ByVal Day As String, ByVal TimeIn As String, ByVal TimeOut As String, ByVal Original_Id As Integer, ByVal Original_StudentId As String, ByVal Original_Name As String, ByVal Original_Date As String, ByVal Original_Day As String, ByVal Original_TimeIn As String, ByVal Original_TimeOut As String, ByVal Id As Integer) As Integer
            If (StudentId Is Nothing) Then
                Throw New Global.System.ArgumentNullException("StudentId")
            Else
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(4).Value = CType(TimeIn,String)
            End If
            If (TimeOut Is Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(5).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(5).Value = CType(TimeOut,String)
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(12).Value = CType(Original_TimeIn,String)
            End If
            If (Original_TimeOut Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(14).Value = CType(Original_TimeOut,String)
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal StudentId As String, ByVal Name As String, ByVal _Date As String, ByVal Day As String, ByVal TimeIn As String, ByVal TimeOut As String, ByVal Original_Id As Integer, ByVal Original_StudentId As String, ByVal Original_Name As String, ByVal Original_Date As String, ByVal Original_Day As String, ByVal Original_TimeIn As String, ByVal Original_TimeOut As String) As Integer
            Return Me.Update(StudentId, Name, _Date, Day, TimeIn, TimeOut, Original_Id, Original_StudentId, Original_Name, Original_Date, Original_Day, Original_TimeIn, Original_TimeOut, Original_Id)
        End Function
    End Class
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As biometricdbDataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As biometricdbDataSet, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._attendanceTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As biometricdbDataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._attendanceTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As biometricdbDataSet) As Integer
