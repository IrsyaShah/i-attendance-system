...
Public Class ExportStudent
    Private Sub btnBrowse_Click_1(sender As Object, e As EventArgs) Handles btnBrowse.Click
        ...
        command.CommandText = "Select Id,Studentid as'Student ID',Name,Class,Standard,Email,Mobile,DOB as'Date of birth',Sex,Address,State,Nationality From personnel where Class = '" & txtClass.Text & "' and Standard = '" & txtStandard.Text & "'"
        ...
        Try
            If f.ShowDialog() = DialogResult.OK Then
                ...
                'Set final path
                Dim fileName As String = "\Student Record Profile" + ".xls"
                ...
                MessageBox.Show("Record exported successfully!", "Student Profile", MessageBoxButtons.OK, MessageBoxIcon.Information)
                FillGridView()
                txtClass.Text = ""
                txtPath.Text = ""
                txtStandard.Text = ""
    ...
    Public Sub FillGridView()
        Try
            ...
            Dim cmd As SqlCommand = New SqlCommand("select Id,Studentid as'Student ID',Name,Class,Standard,Email,Mobile,DOB as'Date of birth',Sex,Address,State,Nationality From personnel", con)
    ...
    Private Sub Button1_Click_2(sender As Object, e As EventArgs) Handles Button1.Click
        Try
            ...
            Dim cmd As SqlCommand = New SqlCommand("select Id,Studentid as'Student ID',Name,Class,Standard,Email,Mobile,DOB as'Date of birth',Sex,Address,State,Nationality From personnel where Class = '" & txtClass.Text & "' and Standard = '" & txtStandard.Text & "' ", con)
